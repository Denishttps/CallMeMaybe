...
language,buttheydon’tnaturallyproducestructured,machine-executableoutput. Func-
...
book,extractfieldssuchas{protagonist name, protagonist sex, protagonist
age}
...
• Theuseof dspy (oranysimilarpackage)iscompletelyforbiddenincludingpytorch,
...
• function_calling_tests.json: containsaJSONarrayofnaturallanguageprompts
...
| V.3   | LLM      |     | Interaction |     |     |     |     |              |     |             |         |     |      |
| V.3.1 |          | The | LLM         | SDK |     |     |     |              |     |             |         |     |      |
Attachedtothisproject,you’llfindawrapperclassSmall_LLM_Modelinthellm_sdk
...
|     |                     |     |     |     |          | "G˙is", | "G˙the", | "G˙sum", |     | "G˙of", "G˙2", | "G˙and", | "G˙3", |      |
| --- | ------------------- | --- | --- | --- | -------- | ------- | -------- | -------- | --- | -------------- | -------- | ------ | ---- |
|     | Example(realistic): |     |     |     | ["What", |         |          |          |     |                |          |        | "?"] |
...
4. LLM Processing: Themodelprocessesthesenumbersthroughitsneuralnetwork.
...
| --- | ------- | --- | -------- | -------- | ------- | --- | --- | --- | --- | --- | --- | --- |
3. Yousetlogitsforinvalidtokens(thosebreakingtheschemaorstructure)tonegative
infinity.
...
YourprogramwillproduceasingleJSONfile: data/output/function_calling_results.json.
...
• Near-perfect accuracy: 90%+correctfunctionselectionandargumentextraction
...
• Recodingthetokenizer: avoidingdirectuseof encodeanddecodeinthemaincode,
...
Bonusfeaturesmustbeimplementedandworking—notjustdescribedintheREADME.md.
